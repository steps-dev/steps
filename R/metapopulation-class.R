...
#' @rdname metapopulation
#' @param object a metapopulation object
...
#' plot(mp)
#' @export
plot.metapopulation <- function(object,...){
  graphics::matplot(0:object$time, base::sapply(object$mp, function(zz) base::apply(zz,2, base::sum)),
                    type = 'l', lty = 1, xlab = "time", ylab = "population size",pch = 1,col="#00000030", ...)
  graphics::lines(0:(object$time), object$sim_p_obs,type = 'l', col='red',lwd=2)  
}