...
demographic_stochast <- function(v, tmat, stmat = NULL, tmat_fecundity = TRUE) {
    .Call('dhmpr_demographic_stochast', PACKAGE = 'dhmpr', v, tmat, stmat, tmat_fecundity)
}
...
#' @export
envir_stochast <- function(tmat, matsd, equalsign = TRUE) {
    .Call('dhmpr_envir_stochast', PACKAGE = 'dhmpr', tmat, matsd, equalsign)
}
