...
```{r single_pop_plot,fig.width = 6, fig.height = 6, dpi = 300, set_xpd = TRUE}
plot(tmat)
```
...
```{r plot_all1,fig.width = 6, fig.height = 6, dpi = 300, set_xpd = TRUE}
plot(dm1)
```
...
```{r plot_all2,fig.width = 6, fig.height = 6, dpi = 300, set_xpd = TRUE}
plot(dm2)
```
