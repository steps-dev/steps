...
We can also perform multiple simulations. For the koala, we specified three replicates of a ten timestep simulation. To improve computation time, we have opted to use multiple processors by specifying a parameter to the 'future' package in the plan() call.
