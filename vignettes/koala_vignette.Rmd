...
Now that we have defined and built the state and dynamic objects, we can run an experiment. We conduct an experiment on the koala population over ten timesteps. Runtime will depend on the complexity of the state object and the configuration of the dynamic object.
