...
Because a simulation object is comprised of multiple experiment result objects, we can subset and plot with similar methods. Here, we plot the population projections for the tenth iteration of the simulation:
